...
public class EquipeServiceImpl implements IEquipeService{
	...
	public Equipe updateEquipe(Equipe updatedEquipe) {
		Equipe existingEquipe = equipeRepository.findById(updatedEquipe.getIdEquipe())
	...
	public void addEtudiantToEquipe(Etudiant etudiant1, Equipe equipe) {
	}

	public void removeEtudiantFromEquipe(Etudiant etudiant1, Equipe equipe) {
	}
>>>>>>> 953064a (commit)
}